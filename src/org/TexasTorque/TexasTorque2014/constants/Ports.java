...
public class Ports {
    ...
    //----- Digital Inputs -----
        //----- Sidecar 1 -----
            public final static int LEFT_FRONT_DRIVE_ENCODER_A_PORT = 5;
            public final static int LEFT_FRONT_DRIVE_ENCODER_B_PORT = 6;
            public final static int RIGHT_FRONT_DRIVE_ENCODER_A_PORT = 1;
            public final static int RIGHT_FRONT_DRIVE_ENCODER_B_PORT = 2;
            public final static int LEFT_REAR_DRIVE_ENCODER_A_PORT = 7;
            public final static int LEFT_REAR_DRIVE_ENCODER_B_PORT = 8;
