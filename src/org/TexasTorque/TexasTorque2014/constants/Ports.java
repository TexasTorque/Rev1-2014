...
public class Ports {
    ...
    public final static int LEFT_FRONT_DRIVE_MOTOR_PORT = 6;
    ...
    //----- Digital Inputs -----
        //----- Sidecar 1 -----
        //----- Sidecar 2 -----
            public final static int LEFT_FRONT_DRIVE_ENCODER_A_PORT = 0;
            public final static int LEFT_FRONT_DRIVE_ENCODER_B_PORT = 0;
            public final static int RIGHT_FRONT_DRIVE_ENCODER_A_PORT = 0;
            public final static int RIGHT_FRONT_DRIVE_ENCODER_B_PORT = 0;
            public final static int LEFT_REAR_DRIVE_ENCODER_A_PORT = 0;
            public final static int LEFT_REAR_DRIVE_ENCODER_B_PORT = 0;
            public final static int RIGHT_REAR_DRIVE_ENCODER_A_PORT = 0;
            public final static int RIGHT_REAR_DRIVE_ENCODER_B_PORT = 0;
            ...
            public final static int LIGHTS_D_PORT = 0;
