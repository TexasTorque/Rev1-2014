...
public class Ports {
    ...
    public final static int RIGHT_REAR_DRIVE_MOTOR_PORT = 8;
    ...
    public final static int CATAPULT_ENCODER_A_PORT = 1;
    public final static int CATAPULT_ENCODER_B_PORT = 2;
    
    public final static int CATAPULT_LIMIT_SWITCH_SIDECAR = 1;
    public final static int CATAPULT_LIMIT_SWITCH_PORT = 1;
    public final static int CATAPULT_LIMIT_SWITCH_B_SIDECAR = 2;
    public final static int CATAPULT_LIMIT_SWITCH_B_PORT = 9;
    
    public final static int PRESSURE_SWITCH_PORT = 7;
