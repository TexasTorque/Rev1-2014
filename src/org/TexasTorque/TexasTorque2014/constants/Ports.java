...
public class Ports {
    ...
    public final static int RIGHT_FRONT_DRIVE_MOTOR_PORT = 3;
    public final static int RIGHT_REAR_DRIVE_MOTOR_PORT = 6;

    public final static int FRONT_INTAKE_TILT_SIDECAR = 1;
    public final static int FRONT_INTAKE_TILT_MOTOR_PORT = 4;
    ...
    public final static int CATAPULT_MOTOR_PORT = 10;
    ...
    public final static int LEFT_REAR_DRIVE_MOTOR_PORT = 8;

    public final static int REAR_INTAKE_TILT_SIDECAR = 1;
    public final static int REAR_INTAKE_TILT_MOTOR_PORT = 2;

    public final static int REAR_INTAKE_SIDECAR = 1;
    public final static int REAR_INTAKE_MOTOR_PORT = 7;

    //----- Solenoids -----
    public final static int FRONT_DRIVEBASE_SWITCHER = 1;//CHECK ALL
    public final static int REAR_DRIVEBASE_SWITCHER = 2;
    public final static int CATAPULT_RELEASE = 4;
    public final static int HOOP = 3;

    //----- Digital Inputs -----
    public final static int LEFT_FRONT_DRIVE_ENCODER_SIDECAR = 1;//CHECK ALL
    ...
    public final static int RIGHT_FRONT_DRIVE_ENCODER_A_PORT = 6;
    public final static int RIGHT_FRONT_DRIVE_ENCODER_B_PORT = 7;

    public final static int LEFT_REAR_DRIVE_ENCODER_SIDECAR = 1;
    public final static int LEFT_REAR_DRIVE_ENCODER_PORT = 12;

    public final static int RIGHT_REAR_DRIVE_ENCODER_SIDECAR = 1;
    public final static int RIGHT_REAR_DRIVE_ENCODER_PORT = 8;

    public final static int CATAPULT_ENCODER_SIDECAR = 1;
    public final static int CATAPULT_ENCODER_A_PORT = 9;
    public final static int CATAPULT_ENCODER_B_PORT = 10;

    public final static int CATAPULT_LIMIT_SWITCH_SIDECAR = 1;
    public final static int CATAPULT_LIMIT_SWITCH_PORT = 13;
    ...
    public final static int FRONT_INTAKE_BUTTON = 2;
    public final static int REAR_INTAKE_BUTTON = 3;

    //----- Analog Inputs -----
    public final static int GYRO_PORT = 1;
    //public final static int ANALOG_PRESSURE_PORT = 0;

    public final static int FRONT_INTAKE_TILT_POT_PORT = 2;//8
